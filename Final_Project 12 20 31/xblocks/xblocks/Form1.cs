    ...
    public partial class Form1 : Form
    {
        ...
        bool y_direction(uint type, uint i, uint j)
        {
            switch (type)
            {
                ...
                case 11:
                    if (i != 0 && !signs[i - 1, j] && !signs[i - 1, j + 1] && !signs[i - 1, j + 2] && !signs[i - 1, j + 3])
                    {
                        return true;
                    }
                    else
                ...
                case 2:
                    if (i != 0 && !signs[i - 1, j] && !signs[i - 1, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 3:
                    if (i != 0 && !signs[i, j - 1] && !signs[i - 1, j] && !signs[i - 1, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 13:
                    if (i != 1 && !signs[i - 2, j] && !signs[i - 1, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 14:
                    if (i != 1 && !signs[i - 1, j] && !signs[i - 2, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 5:
                    if (i != 0 && !signs[i - 1, j] && !signs[i, j + 1] && !signs[i, j + 2])
                    {
                        return true;
                    }
                    else
                ...
                case 25:
                    if (i != 1 && !signs[i - 2, j] && !signs[i - 2, j - 1] && !signs[i - 2, j - 2])
                    {
                        return true;
                    }
                    else
                ...
                case 35:
                    if (i != 2 && !signs[i - 1, j] && !signs[i - 3, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 6:
                    if (i != 0 && !signs[i, j - 1] && !signs[i, j - 2] && !signs[i - 1, j])
                    {
                        return true;
                    }
                    else
                ...
                case 7:
                    if (i != 0 && !signs[i - 1, j - 1] && !signs[i - 1, j] && !signs[i - 1, j + 1])
                    {
                        return true;
                    }
                    else
                ...
                case 27:
                    if (i != 1 && !signs[i - 1, j - 1] && !signs[i - 1, j + 1] && !signs[i - 2, j])
                    {
                        return true;
                    }
                    else
        ...
        bool x_direction(uint type, uint i, uint j, int d)
        {
            switch (type)
            {
                case 1:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i + 1, j - 1] && !signs[i + 2, j - 1] && !signs[i + 3, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 9 && !signs[i, j + 1] && !signs[i + 1, j + 1] && !signs[i + 2, j + 1] && !signs[i + 3, j + 1])
                        {
                            return true;
                        }
                        else
                ...
                case 2:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i + 1, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i + 1, j + 2])
                        {
                            return true;
                        }
                        else
                ...
                case 3:
                    if (d == -1)
                    {
                        if (j != 1 && !signs[i, j - 1] && !signs[i + 1, j - 2])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i + 1, j + 1])
                        {
                            return true;
                        }
                        else
                ...
                case 13:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i + 1, j] && !signs[i + 1, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i + 1, j + 2] && !signs[i - 1, j + 1])
                        {
                            return true;
                        }
                        else
                ...
                case 4:
                    if (d == -1)
                    {
                        if (j != 1 && !signs[i, j - 2] && !signs[i + 1, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 1] && !signs[i + 1, j + 2])
                        {
                            return true;
                        }
                        else
                ...
                case 14:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i + 1, j - 1] && !signs[i - 1, j])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i + 1, j + 1] && !signs[i - 1, j + 2])
                        {
                            return true;
                        }
                        else
                ...
                case 5:
                    ...
                    {
                        if (j != 7 && !signs[i, j + 1] && !signs[i + 1, j + 3])
                        {
                            return true;
                        }
                        else
                ...
                case 15:
                    if (d == -1)
                    {
                        if (j != 1 && !signs[i, j - 2] && !signs[i + 1, j - 2] && !signs[i + 2, j - 2])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 9 && !signs[i, j + 1] && !signs[i + 1, j] && !signs[i + 2, j])
                        {
                            return true;
                        }
                        else
                ...
                case 25:
                    if (d == -1)
                    {
                        if (j != 2 && !signs[i, j - 1] && !signs[i - 1, j - 3])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 9 && !signs[i, j + 1] && !signs[i - 1, j + 1])
                        {
                            return true;
                        }
                        else
                ...
                case 35:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i - 1, j] && !signs[i - 2, j])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i - 1, j + 2] && !signs[i - 2, j + 2])
                        {
                            return true;
                        }
                        else
                ...
                case 17:
                    if (d == -1)
                    {
                        if (j != 0 && !signs[i, j - 1] && !signs[i + 1, j - 1] && !signs[i - 1, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 8 && !signs[i, j + 2] && !signs[i + 1, j + 1] && !signs[i - 1, j + 1])
                        {
                            return true;
                        }
                        else
                ...
                case 37:
                    if (d == -1)
                    {
                        if (j != 1 && !signs[i, j - 2] && !signs[i + 1, j - 1] && !signs[i - 1, j - 1])
                        {
                            return true;
                        }
                        else
                    ...
                    {
                        if (j != 9 && !signs[i, j + 1] && !signs[i + 1, j + 1] && !signs[i - 1, j + 1])
                        {
                            return true;
                        }
                        else
